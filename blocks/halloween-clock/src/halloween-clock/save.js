				...
				<section className="stage">
					<figure className="clock">
						...
						<ul className="clock-face">
							<li className="hand hour" id="hour-hand"></li>
							<li className="hand minute" id="minute-hand"></li>
							<li className="hand second" id="second-hand"></li>
					...
					<ul className="countdown-container">
						<li className="countdown-item">
							<figure className="circle" id="days-ring">
								<figcaption className="inner">
									<time className="number" id="days-value">00</time>
						...
						<li className="countdown-item">
							<figure className="circle" id="hours-ring">
								<figcaption className="inner">
									<time className="number" id="hours-value">00</time>
						...
						<li className="countdown-item">
							<figure className="circle" id="minutes-ring">
								<figcaption className="inner">
									<time className="number" id="minutes-value">00</time>
						...
						<li className="countdown-item">
							<figure className="circle" id="seconds-ring">
								<figcaption className="inner">
									<time className="number" id="seconds-value">00</time>
